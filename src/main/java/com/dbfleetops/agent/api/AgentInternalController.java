...
public class AgentInternalController {
        ...
        public AgentInternalController(AgentService agentService) {
        ...
        public ResponseEntity<AgentHeartbeatResponse> heartbeat(@PathVariable Long agentId,
                        @RequestBody AgentHeartbeatRequest request) {
                return ResponseEntity.ok(agentService.heartbeat(agentId, request));
        }
}
