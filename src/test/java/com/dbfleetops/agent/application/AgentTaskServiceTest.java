...
class AgentTaskServiceTest {
    ...
    void nextTaskReturnsQueuedTask() {
        ...
        when(taskRepository.findTop1ByAgentIdAndStatusOrderByCreatedAtAsc(
                1L,
        ...
        NextAgentTaskResponse response =
                service.nextTask(
                        1L,
                        "agent-token-001"
                );

        assertThat(response.hasTask())
                .isTrue();
    ...
    void completeTaskChangesRunningTaskToSucceeded() {
        ...
        assertThat(response.resultPayloadJson())
