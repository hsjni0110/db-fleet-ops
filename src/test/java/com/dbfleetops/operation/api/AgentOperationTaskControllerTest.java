...
class AgentOperationTaskControllerTest {
    ...
    @MockitoBean OperationTaskService taskService;
    @MockitoBean OperationTaskClaimService claimService;
    @MockitoBean OperationTaskLeaseService leaseService;
    @MockitoBean TaskCredentialService credentialService;
