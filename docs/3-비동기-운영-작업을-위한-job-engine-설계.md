...
이 문제를 해결하기 위해 Phase 4에서는 Operation Job 구조를 도입했습니다.
...
retryable=true이고 retryCount < maxRetryCount이면 Job은 다시 QUEUED 상태로 돌아갑니다.
...
이번 Phase 4에서 구현한 핵심은 실제 백업 명령 실행이 아니라, 운영 작업을 안전하게 다루기 위한 Job Engine의 기본 구조입니다.
